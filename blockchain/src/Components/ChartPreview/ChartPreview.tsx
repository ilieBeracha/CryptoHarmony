...
function ChartPreview({ data, type, byDate, setByDate }: { data: CoinModel, type: string, byDate: string, setByDate: any }): JSX.Element {
    ...
    return (
        <div className="ChartPreviewComponent">
            <div className='ChartPreviewFilters'>
                <Box sx={{ width: 500 }}>
                    <BottomNavigation
                        showLabels
            ...
            <div className='ChartPreview' ref={chartContainerRef}></div>
            <div className='ChartPreviewFilters'>
                {
                    graphType === "price" ?
